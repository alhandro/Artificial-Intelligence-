...
G = nx.Graph()
nodes=["SComplex","Siwaka","Ph.1A","Ph.1B","STC","Phase2","J1","Mada","Phase3","ParkingLot"]
G.add_nodes_from(nodes)
G.nodes()#confirm nodes
#Add Edges and their weights
G.add_edge("SComplex","Siwaka",weight="UnkRoad450m")
...
routes = route_bfs.BFS(G,"SComplex","ParkingLot")
